...
import kotlinx.android.synthetic.main.activity_janken2_result.*

class Janken2ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_janken2_result)
        // インテントからデータを取り出す
