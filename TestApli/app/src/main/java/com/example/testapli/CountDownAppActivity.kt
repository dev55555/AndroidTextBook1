...
import kotlinx.android.synthetic.main.activity_count_down_app.*

class CountDownAppActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_count_down_app)
